...
public interface ITourbookPreferences {
   ...
   public static final String MERGE_TOUR_MERGE_GRAPH_CUSTOMTRACKS = "merge.tour.merge-graph-customtracks";          //$NON-NLS-1$
    ...
    * Weather
    */
   //This is the api key for owm weather online
   public static final String WEATHER_OWM_API_KEY         = "WEATHER_OWM_API_KEY";         //$NON-NLS-1$

...
public class TourCustomFieldsView extends ViewPart implements ITourProvider, ITourViewer {
   public static final String      ID                = "net.tourbook.views.TourCustomFieldsView"; //$NON-NLS-1$
   ...
   private TableViewer _customFieldsViewer;
   ...
   private static class CustomFieldsComparator extends ViewerComparator {

      @Override
      public int compare(final Viewer viewer, final Object e1, final Object e2) {

         final CustomFieldValue ct1 = (CustomFieldValue) e1;
         final CustomFieldValue ct2 = (CustomFieldValue) e2;

         /*
          * sort by name
          */
         final String ct1Name = ct1.getCustomField().getFieldName();
         final String ct2Name = ct2.getCustomField().getFieldName();
   ...
   class CustomFieldsViewerContentProvider implements IStructuredContentProvider {
      ...
      public Object[] getElements(final Object inputElement) {
         if (_tourData == null) {
            ...
            return _tourData.getCustomFieldValues().toArray();
         }
      }
      ...
      _prefChangeListener = new IPropertyChangeListener() {
         ...
         public void propertyChange(final PropertyChangeEvent event) {
            ...
            if (property.equals(ITourbookPreferences.VIEW_LAYOUT_CHANGED)) {
               ...
               _customFieldsViewer.getTable().setLinesVisible(_prefStore.getBoolean(ITourbookPreferences.VIEW_LAYOUT_DISPLAY_LINES));
               _customFieldsViewer.refresh();
            }
         }
      };
      ...
      _prefChangeListener_Common = new IPropertyChangeListener() {
         ...
         public void propertyChange(final PropertyChangeEvent event) {
            ...
            if (property.equals(ICommonPreferences.MEASUREMENT_SYSTEM)) {
               ...
               _customFieldsViewer = (TableViewer) recreateViewer(_customFieldsViewer);
            }
         }
      };
   ...
   private void addSelectionListener() {
      ...
      _postSelectionListener = new ISelectionListener() {
         ...
         public void selectionChanged(final IWorkbenchPart part, final ISelection selection) {
            if (part == TourCustomFieldsView.this) {
               return;
            }
   ...
   private void addTourEventListener() {
      ...
      _tourPropertyListener = new ITourEventListener() {
         ...
         public void tourChanged(final IWorkbenchPart part, final TourEventId eventId, final Object eventData) {
            ...
            if ((_tourData == null) || (part == TourCustomFieldsView.this)) {
               return;
            }
...
//    _actionEditTourWaypoints = new ActionOpenMarkerDialog(this, true);
   ...
   private void createUI_10_CustomTracksViewer(final Composite parent) {
       ...
       * create table viewer
       */
      _customFieldsViewer = new TableViewer(table);
      _columnManager.createColumns(_customFieldsViewer);

      _customFieldsViewer.setContentProvider(new CustomFieldsViewerContentProvider());
      _customFieldsViewer.setComparator(new CustomFieldsComparator());

      _customFieldsViewer.addSelectionChangedListener(new ISelectionChangedListener() {
         @Override
      ...
      _customFieldsViewer.addDoubleClickListener(new IDoubleClickListener() {
         @Override
   ...
   private void createUI_20_ContextMenu() {
      ...
      final Table table = (Table) _customFieldsViewer.getControl();
   ...
   private void defineColumn_Id() {
      ...
      colDef.setLabelProvider(new CellLabelProvider() {
         ...
         public void update(final ViewerCell cell) {
            ...
            final CustomFieldValue ct = (CustomFieldValue) cell.getElement();
            cell.setText(ct.getCustomField().getRefId());
         }
      });
   }
   ...
   private void defineColumn_Type() {
      ...
      colDef.setLabelProvider(new CellLabelProvider() {
         ...
         public void update(final ViewerCell cell) {
            ...
            final CustomFieldValue ct = (CustomFieldValue) cell.getElement();
            cell.setText(String.valueOf(ct.getCustomField().getFieldType().toString()));
         }
      });
   }
   ...
   private void defineColumn_Unit() {
      ...
      colDef.setLabelProvider(new CellLabelProvider() {
         ...
         public void update(final ViewerCell cell) {
            ...
            final CustomFieldValue ct = (CustomFieldValue) cell.getElement();
            cell.setText(ct.getCustomField().getUnit());
         }
      });
   }
    ...
    * column: value
    */
   private void defineColumn_Value() {

      final ColumnDefinition colDef = TableColumnFactory.CUSTOM_FIELDS_VALUE.createColumn(_columnManager, _pc);
      colDef.setIsDefaultColumn();
      colDef.setLabelProvider(new CellLabelProvider() {
         @Override
         public void update(final ViewerCell cell) {
...
//    _actionEditTourWaypoints.setEnabled(isTour);
   ...
   public ColumnViewer recreateViewer(final ColumnViewer columnViewer) {
      ...
      {
         _customFieldsViewer.getTable().dispose();
   ...
   private void saveState() {
      ...
      final Table table = _customFieldsViewer.getTable();
      if (table.isDisposed()) {
         return;
      }
   ...
   public void setFocus() {
      _customFieldsViewer.getTable().setFocus();
   }

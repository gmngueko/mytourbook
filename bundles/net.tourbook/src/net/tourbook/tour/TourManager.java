...
// SET_FORMATTING_ON
   ...
   private ChartDataYSerie createModelData_CustomTracks(final float[] customTracksSerie,
      ...
      if (customTracksSerie != null && customTrackDefinition != null) {
         ...
         yDataCustomTracksSerie.setCustomData(ChartDataYSerie.YDATA_GRAPH_ID, GRAPH_CUSTOM_TRACKS + indexCustomTracksSerie);
         ...
         setGraphColors(yDataCustomTracksSerie, GraphColorManager.PREF_GRAPH_CUSTOM_TRACKS);

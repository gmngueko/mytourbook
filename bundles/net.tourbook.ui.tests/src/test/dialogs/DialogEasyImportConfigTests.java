...
public class DialogEasyImportConfigTests extends UITest {
   ...
   void configureEasyImport() {
      ...
      // "  &3 +  "
      bot.cTabItem(DialogEasyImportConfig.IMPORT_LAUNCHER_TAB_03_TOUR_TYPE).activate();
      ...
      //  " &4 . . . 9 "
      bot.cTabItem(DialogEasyImportConfig.IMPORT_LAUNCHER_TAB_04).activate();
      ...
      // " &50 . . . 99 "
      bot.cTabItem(DialogEasyImportConfig.IMPORT_LAUNCHER_TAB_50).activate();
